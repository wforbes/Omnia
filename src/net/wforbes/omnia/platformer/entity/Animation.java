...
public class Animation {
	...
	private BufferedImage[] frames;//holds all the frames for the animation
	...
	public BufferedImage getImage(){ return frames[currentFrame]; }//this will get the image that we need to draw
